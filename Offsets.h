namespace offsets {
        ...
        namespace player {
                ...
                constexpr auto weapon_index = 0x858;
...
uintptr_t decrypt_client_info()
{
        ...
        rbx = read<uintptr_t>(baseModuleAddr + 0x1806E058);
        if(!rbx)
                return rbx;
        ...
        rax ^= rdx;             //xor rax, rdx
        rcx ^= read<uintptr_t>(baseModuleAddr + 0x71D90F2);             //xor rcx, [0x0000000004E90B48]
        rcx = ~rcx;             //not rcx
        rbx = read<uintptr_t>(rcx + 0x13);              //mov rbx, [rcx+0x13]
...
{
        uint64_t rax = baseModuleAddr, rbx = baseModuleAddr, rcx = baseModuleAddr, rdx = baseModuleAddr, rdi = baseModuleAddr, rsi = baseModuleAddr, r8 = baseModuleAddr, r9 = baseModuleAddr, r10 = baseModuleAddr, r11 = baseModuleAddr, r12 = baseModuleAddr, r13 = baseModuleAddr, r14 = baseModuleAddr, r15 = baseModuleAddr;
        rax = read<uintptr_t>(client_info + 0x9fde8);
        if(!rax)
                return rax;
        uint64_t rax = baseModuleAddr, rbx = baseModuleAddr, rcx = baseModuleAddr, rdx = baseModuleAddr, rdi = baseModuleAddr, rsi = baseModuleAddr, r8 = baseModuleAddr, r9 = baseModuleAddr, r10 = baseModuleAddr, r11 = baseModuleAddr, r12 = baseModuleAddr, r13 = baseModuleAddr, r14 = baseModuleAddr, r15 = baseModuleAddr;
        rax = read<uintptr_t>(client_info + 0x9fde8);
        ...
        case 0:
        {
                rbx = baseModuleAddr;           //lea rbx, [0xFFFFFFFFFDCB79CF]
                r9 = read<uintptr_t>(baseModuleAddr + 0x71D912F);               //mov r9, [0x0000000004E90A62]
                rcx = rdi;              //mov rcx, rdi
                rcx = ~rcx;             //not rcx
                rcx -= rbx;             //sub rcx, rbx
                ...
                rcx ^= r9;              //xor rcx, r9
                rcx = ~rcx;             //not rcx
                rax *= read<uintptr_t>(rcx + 0x5);              //imul rax, [rcx+0x05]
                return rax;
        }
        case 1:
        {
                r11 = read<uintptr_t>(baseModuleAddr + 0x71D912F);              //mov r11, [0x0000000004E9057D]
                rbx = baseModuleAddr;           //lea rbx, [0xFFFFFFFFFDCB7447]
                rdx = baseModuleAddr + 0x290C;          //lea rdx, [0xFFFFFFFFFDCB9CFD]
        ...
        case 2:
        {
                r10 = read<uintptr_t>(baseModuleAddr + 0x71D912F);              //mov r10, [0x0000000004E9011C]
                ...
                rcx ^= rax;             //xor rcx, rax
                rax = read<uintptr_t>(rdx + 0x5);               //mov rax, [rdx+0x05]
                rax *= rcx;             //imul rax, rcx
        ...
        case 3:
        {
                rbx = baseModuleAddr;           //lea rbx, [0xFFFFFFFFFDCB6C79]
                r15 = baseModuleAddr + 0x3483EDA1;              //lea r15, [0x00000000324F5A02]
                r10 = read<uintptr_t>(baseModuleAddr + 0x71D912F);              //mov r10, [0x0000000004E8FD42]
                r11 = 0xE95C245BB2EE5516;               //mov r11, 0xE95C245BB2EE5516
                rcx = 0;                //and rcx, 0xFFFFFFFFC0000000
                rcx = _rotl64(rcx, 0x10);               //rol rcx, 0x10
                rcx ^= r10;             //xor rcx, r10
                rcx = ~rcx;             //not rcx
                rcx = read<uintptr_t>(rcx + 0x5);               //mov rcx, [rcx+0x05]
        ...
        case 4:
        {
                r15 = baseModuleAddr + 0xC7B6;          //lea r15, [0xFFFFFFFFFDCC3039]
                r10 = read<uintptr_t>(baseModuleAddr + 0x71D912F);              //mov r10, [0x0000000004E8F931]
                rdx = 0;                //and rdx, 0xFFFFFFFFC0000000
                rdx = _rotl64(rdx, 0x10);               //rol rdx, 0x10
                rdx ^= r10;             //xor rdx, r10
                ...
                rax ^= rcx;             //xor rax, rcx
                rcx = baseModuleAddr + 0x6741;          //lea rcx, [0xFFFFFFFFFDCBCDEE]
                rcx = ~rcx;             //not rcx
                rcx += rax;             //add rcx, rax
        ...
        case 5:
        {
                rbx = baseModuleAddr;           //lea rbx, [0xFFFFFFFFFDCB62E5]
                rdx = baseModuleAddr + 0x8569;          //lea rdx, [0xFFFFFFFFFDCBE836]
                r15 = baseModuleAddr + 0xAA0B;          //lea r15, [0xFFFFFFFFFDCC0CCC]
                r10 = read<uintptr_t>(baseModuleAddr + 0x71D912F);              //mov r10, [0x0000000004E8F39B]
                rcx = rdx;              //mov rcx, rdx
                rcx = ~rcx;             //not rcx
                rcx ^= rdi;             //xor rcx, rdi
                rax -= rcx;             //sub rax, rcx
        ...
        case 6:
        {
                rbx = baseModuleAddr;           //lea rbx, [0xFFFFFFFFFDCB5D91]
                r9 = read<uintptr_t>(baseModuleAddr + 0x71D912F);               //mov r9, [0x0000000004E8EE69]
                rcx = 0;                //and rcx, 0xFFFFFFFFC0000000
                rcx = _rotl64(rcx, 0x10);               //rol rcx, 0x10
                rcx ^= r9;              //xor rcx, r9
                rcx = ~rcx;             //not rcx
        ...
        case 7:
        {
                r10 = read<uintptr_t>(baseModuleAddr + 0x71D912F);              //mov r10, [0x0000000004E8EA31]
                rbx = baseModuleAddr;           //lea rbx, [0xFFFFFFFFFDCB58FB]
                rcx = 0;                //and rcx, 0xFFFFFFFFC0000000
                rcx = _rotl64(rcx, 0x10);               //rol rcx, 0x10
                rcx ^= r10;             //xor rcx, r10
                rcx = ~rcx;             //not rcx
                ...
                rdx = rdi;              //mov rdx, rdi
                rdx = ~rdx;             //not rdx
                rcx = baseModuleAddr + 0x7525;          //lea rcx, [0xFFFFFFFFFDCBCB48]
                rdx += rcx;             //add rdx, rcx
                rcx = rax;              //mov rcx, rax
        ...
        case 8:
        {
                rbx = baseModuleAddr;           //lea rbx, [0xFFFFFFFFFDCB5488]
                r11 = baseModuleAddr + 0x54BDDC6C;              //lea r11, [0x00000000528930DC]
                r9 = read<uintptr_t>(baseModuleAddr + 0x71D912F);               //mov r9, [0x0000000004E8E547]
                rax -= rbx;             //sub rax, rbx
        ...
        case 9:
        {
                r10 = read<uintptr_t>(baseModuleAddr + 0x71D912F);              //mov r10, [0x0000000004E8E072]
                rbx = baseModuleAddr + 0x285FB43A;              //lea rbx, [0x00000000262B0365]
                rcx = rax;              //mov rcx, rax
        ...
        case 10:
        {
                r9 = read<uintptr_t>(baseModuleAddr + 0x71D912F);               //mov r9, [0x0000000004E8DAC4]
        ...
        case 11:
        {
                r10 = read<uintptr_t>(baseModuleAddr + 0x71D912F);              //mov r10, [0x0000000004E8D5E1]
                rcx = rax;              //mov rcx, rax
        ...
        case 12:
        {
                rbx = baseModuleAddr;           //lea rbx, [0xFFFFFFFFFDCB3FA2]
                r15 = baseModuleAddr + 0x6171;          //lea r15, [0xFFFFFFFFFDCBA0FB]
                r10 = read<uintptr_t>(baseModuleAddr + 0x71D912F);              //mov r10, [0x0000000004E8D084]
                rcx = rdi;              //mov rcx, rdi
                rcx ^= r15;             //xor rcx, r15
                rax += rcx;             //add rax, rcx
                rax ^= rbx;             //xor rax, rbx
        ...
        case 13:
        {
                rbx = baseModuleAddr;           //lea rbx, [0xFFFFFFFFFDCB3B5A]
                r9 = read<uintptr_t>(baseModuleAddr + 0x71D912F);               //mov r9, [0x0000000004E8CC04]
                rcx = 0;                //and rcx, 0xFFFFFFFFC0000000
                rcx = _rotl64(rcx, 0x10);               //rol rcx, 0x10
                rcx ^= r9;              //xor rcx, r9
                rcx = ~rcx;             //not rcx
                ...
                rax ^= rcx;             //xor rax, rcx
                rax -= rdi;             //sub rax, rdi
                rcx = baseModuleAddr + 0x61F;           //lea rcx, [0xFFFFFFFFFDCB3E10]
                rax += rcx;             //add rax, rcx
                rcx = rax;              //mov rcx, rax
                rcx >>= 0x27;           //shr rcx, 0x27
                rax ^= rcx;             //xor rax, rcx
        ...
        case 14:
        {
                r9 = read<uintptr_t>(baseModuleAddr + 0x71D912F);               //mov r9, [0x0000000004E8C800]
                rcx = rax;              //mov rcx, rax
                rcx >>= 0xF;            //shr rcx, 0x0F
                rax ^= rcx;             //xor rax, rcx
                rcx = rax;              //mov rcx, rax
        ...
        case 15:
        {
                rbx = baseModuleAddr;           //lea rbx, [0xFFFFFFFFFDCB3204]
                r13 = 0x3C85E73829FCC7AD;               //mov r13, 0x3C85E73829FCC7AD
                r10 = read<uintptr_t>(baseModuleAddr + 0x71D912F);              //mov r10, [0x0000000004E8C2C9]
...
uintptr_t decrypt_bone_base(uintptr_t client_info)
{
        uint64_t rax = baseModuleAddr, rbx = baseModuleAddr, rcx = baseModuleAddr, rdx = baseModuleAddr, rdi = baseModuleAddr, rsi = baseModuleAddr, r8 = baseModuleAddr, r9 = baseModuleAddr, r10 = baseModuleAddr, r11 = baseModuleAddr, r12 = baseModuleAddr, r13 = baseModuleAddr, r14 = baseModuleAddr, r15 = baseModuleAddr;
        rdx = read<uintptr_t>(baseModuleAddr + 0x15E18A18);
        if(!rdx)
                return rdx;
        uint64_t rax = baseModuleAddr, rbx = baseModuleAddr, rcx = baseModuleAddr, rdx = baseModuleAddr, rdi = baseModuleAddr, rsi = baseModuleAddr, r8 = baseModuleAddr, r9 = baseModuleAddr, r10 = baseModuleAddr, r11 = baseModuleAddr, r12 = baseModuleAddr, r13 = baseModuleAddr, r14 = baseModuleAddr, r15 = baseModuleAddr;
        rdx = read<uintptr_t>(baseModuleAddr + 0x15E18A18);
        ...
        case 0:
        {
                r10 = read<uintptr_t>(baseModuleAddr + 0x71D924F);              //mov r10, [0x0000000004B6109C]
                r14 = baseModuleAddr + 0x676D94A3;              //lea r14, [0x00000000650612DD]
                rax = rdx;              //mov rax, rdx
                ...
                rdx *= read<uintptr_t>(rax + 0xb);              //imul rdx, [rax+0x0B]
                rax = baseModuleAddr + 0x3496E896;              //lea rax, [0x00000000322F641C]
                r13 = 0x891801D00A4665B;                //mov r13, 0x891801D00A4665B
                rax = ~rax;             //not rax
                rax -= r8;              //sub rax, r8
                rax += r13;             //add rax, r13
                rdx += rax;             //add rdx, rax
                rax = baseModuleAddr;           //lea rax, [0xFFFFFFFFFD987D29]
                rdx ^= rax;             //xor rdx, rax
        ...
        case 1:
        {
                ...
                r12 = baseModuleAddr + 0x74050ED8;              //lea r12, [0x00000000719D87A4]
                rbx = read<uintptr_t>(baseModuleAddr + 0x71D924F);              //mov rbx, [0x0000000004B60AB3]
                rax = r12;              //mov rax, r12
                rax -= r8;              //sub rax, r8
                rdx += rax;             //add rdx, rax
                rdx -= r8;              //sub rdx, r8
                ...
                rdx = read<uintptr_t>(rcx + 0xb);               //mov rdx, [rcx+0x0B]
                rdx *= rax;             //imul rdx, rax
                rax = rdx;              //mov rax, rdx
        ...
        case 2:
        {
                rbx = read<uintptr_t>(baseModuleAddr + 0x71D924F);              //mov rbx, [0x0000000004B605A6]
                rax = rdx;              //mov rax, rdx
                ...
                rcx = r8;               //mov rcx, r8
                rcx = ~rcx;             //not rcx
                rax = baseModuleAddr + 0x8D63;          //lea rax, [0xFFFFFFFFFD98FD2E]
                rdx += rax;             //add rdx, rax
                rdx += rcx;             //add rdx, rcx
        ...
        {
                //failed to translate: pop rdx
                rbx = read<uintptr_t>(baseModuleAddr + 0x71D924F);              //mov rbx, [0x0000000004B6014B]
                rdx += r8;              //add rdx, r8
                rax = rdx;              //mov rax, rdx
                ...
                rcx = _rotl64(rcx, 0x10);               //rol rcx, 0x10
                rcx ^= rbx;             //xor rcx, rbx
                rax = baseModuleAddr;           //lea rax, [0xFFFFFFFFFD986BCF]
                rdx -= rax;             //sub rdx, rax
        ...
        case 4:
        {
                rbx = read<uintptr_t>(baseModuleAddr + 0x71D924F);              //mov rbx, [0x0000000004B5FB42]
                rax = r8;               //mov rax, r8
                rax = baseModuleAddr;           //sub rax, [rbp+0x48] -- didn't find trace -> use base
                rax -= 0x4929CCC0;              //sub rax, 0x4929CCC0
                rdx ^= rax;             //xor rdx, rax
                rax = r8;               //mov rax, r8
                rax = ~rax;             //not rax
                uintptr_t RSP_0x48;
                RSP_0x48 = baseModuleAddr + 0x6D8B;             //lea rax, [0xFFFFFFFFFD98D6D9] : RSP+0x48
                ...
                rdx ^= rax;             //xor rdx, rax
                rax = baseModuleAddr;           //lea rax, [0xFFFFFFFFFD9866AB]
                rdx -= rax;             //sub rdx, rax
                rax = 0;                //and rax, 0xFFFFFFFFC0000000
                rax = _rotl64(rax, 0x10);               //rol rax, 0x10
                rax ^= rbx;             //xor rax, rbx
                rax = _byteswap_uint64(rax);            //bswap rax
                rax = read<uintptr_t>(rax + 0xb);               //mov rax, [rax+0x0B]
                uintptr_t RSP_0x78;
        ...
        case 5:
        {
                rbx = read<uintptr_t>(baseModuleAddr + 0x71D924F);              //mov rbx, [0x0000000004B5F6B0]
                r15 = baseModuleAddr + 0xC902;          //lea r15, [0xFFFFFFFFFD992D50]
                rax = r8;               //mov rax, r8
                ...
                rdx *= rax;             //imul rdx, rax
                rax = baseModuleAddr;           //lea rax, [0xFFFFFFFFFD985FC8]
                ...
                rax >>= 0x30;           //shr rax, 0x30
                rdx ^= rax;             //xor rdx, rax
                rax = baseModuleAddr + 0xD9F3;          //lea rax, [0xFFFFFFFFFD9938E9]
                rdx -= r8;              //sub rdx, r8
                rdx += rax;             //add rdx, rax
                rax = rdx;              //mov rax, rdx
        ...
        case 6:
        {
                rbx = read<uintptr_t>(baseModuleAddr + 0x71D924F);              //mov rbx, [0x0000000004B5F099]
                r12 = baseModuleAddr + 0x56AD1EF7;              //lea r12, [0x0000000054457D2E]
                rcx = 0;                //and rcx, 0xFFFFFFFFC0000000
                rax = rdx;              //mov rax, rdx
                rcx = _rotl64(rcx, 0x10);               //rol rcx, 0x10
                rax >>= 0x26;           //shr rax, 0x26
                ...
                rdx *= rax;             //imul rdx, rax
                rdx -= r8;              //sub rdx, r8
                rax = baseModuleAddr;           //lea rax, [0xFFFFFFFFFD985CD4]
                rdx ^= rax;             //xor rdx, rax
        ...
        case 7:
        {
                rbx = read<uintptr_t>(baseModuleAddr + 0x71D924F);              //mov rbx, [0x0000000004B5EBB1]
                ...
                rax = _byteswap_uint64(rax);            //bswap rax
                rdx *= read<uintptr_t>(rax + 0xb);              //imul rdx, [rax+0x0B]
                rax = baseModuleAddr;           //lea rax, [0xFFFFFFFFFD985735]
                rdx ^= rax;             //xor rdx, rax
                rdx -= rax;             //sub rdx, rax
                rcx += rdx;             //add rcx, rdx
                rax = rcx;              //mov rax, rcx
        ...
        case 8:
        {
                rbx = read<uintptr_t>(baseModuleAddr + 0x71D924F);              //mov rbx, [0x0000000004B5E82C]
                r12 = baseModuleAddr + 0xC270;          //lea r12, [0xFFFFFFFFFD99183A]
                rcx = r8;               //mov rcx, r8
                rax = r12;              //mov rax, r12
                rax = ~rax;             //not rax
                rcx = ~rcx;             //not rcx
                ...
                rdx += rax;             //add rdx, rax
                rax = baseModuleAddr + 0x6F41;          //lea rax, [0xFFFFFFFFFD98BF75]
                rax = ~rax;             //not rax
        ...
        case 9:
        {
                r10 = read<uintptr_t>(baseModuleAddr + 0x71D924F);              //mov r10, [0x0000000004B5E1C8]
                rax = 0;                //and rax, 0xFFFFFFFFC0000000
                rax = _rotl64(rax, 0x10);               //rol rax, 0x10
                rax ^= r10;             //xor rax, r10
                rax = _byteswap_uint64(rax);            //bswap rax
                rdx *= read<uintptr_t>(rax + 0xb);              //imul rdx, [rax+0x0B]
                rdx += r8;              //add rdx, r8
                rax = baseModuleAddr;           //lea rax, [0xFFFFFFFFFD984DD1]
                rax += 0x11B6;          //add rax, 0x11B6
                rax += r8;              //add rax, r8
                rdx ^= rax;             //xor rdx, rax
                rax = baseModuleAddr;           //lea rax, [0xFFFFFFFFFD984DBE]
                rdx -= rax;             //sub rdx, rax
                rax = rdx;              //mov rax, rdx
                rax >>= 0x5;            //shr rax, 0x05
                rdx ^= rax;             //xor rdx, rax
        ...
        case 10:
        {
                r14 = baseModuleAddr + 0x1DD8;          //lea r14, [0xFFFFFFFFFD986885]
                r15 = baseModuleAddr + 0x53356CF1;              //lea r15, [0x0000000050CDB792]
                r10 = read<uintptr_t>(baseModuleAddr + 0x71D924F);              //mov r10, [0x0000000004B5DC7D]
                rax = r8;               //mov rax, r8
                rax = ~rax;             //not rax
                rax ^= r14;             //xor rax, r14
                rdx -= rax;             //sub rdx, rax
                ...
                rdx *= rax;             //imul rdx, rax
                rax = baseModuleAddr;           //lea rax, [0xFFFFFFFFFD9846C7]
                rdx -= rax;             //sub rdx, rax
                return rdx;
        }
        case 11:
        {
                rbx = read<uintptr_t>(baseModuleAddr + 0x71D924F);              //mov rbx, [0x0000000004B5D728]
                r12 = baseModuleAddr + 0x7A87E289;              //lea r12, [0x0000000078202743]
                rax = r8;               //mov rax, r8
                rax = ~rax;             //not rax
                uintptr_t RSP_0x48;
                RSP_0x48 = baseModuleAddr + 0x4D63C65D;                 //lea rax, [0x000000004AFC0B2F] : RSP+0x48
                rax += RSP_0x48;                //add rax, [rsp+0x48]
                rdx ^= rax;             //xor rdx, rax
                rax = 0;                //and rax, 0xFFFFFFFFC0000000
                rax = _rotl64(rax, 0x10);               //rol rax, 0x10
                ...
                rax += r12;             //add rax, r12
                rdx ^= rax;             //xor rdx, rax
                rax = baseModuleAddr;           //lea rax, [0xFFFFFFFFFD984165]
        ...
        {
                //failed to translate: pop rdx
                rbx = read<uintptr_t>(baseModuleAddr + 0x71D924F);              //mov rbx, [0x0000000004B5D15B]
                rax = rdx;              //mov rax, rdx
                rax >>= 0x14;           //shr rax, 0x14
                rdx ^= rax;             //xor rdx, rax
                rax = rdx;              //mov rax, rdx
        ...
        case 13:
        {
                rbx = read<uintptr_t>(baseModuleAddr + 0x71D924F);              //mov rbx, [0x0000000004B5CCD7]
                r15 = baseModuleAddr + 0x4C7B;          //lea r15, [0xFFFFFFFFFD9886F0]
                ...
                rdx ^= rax;             //xor rdx, rax
                rdx -= r8;              //sub rdx, r8
                rax = baseModuleAddr;           //lea rax, [0xFFFFFFFFFD98398C]
                rdx -= rax;             //sub rdx, rax
        ...
        case 14:
        {
                r9 = read<uintptr_t>(baseModuleAddr + 0x71D924F);               //mov r9, [0x0000000004B5C707]
                rax = baseModuleAddr;           //lea rax, [0xFFFFFFFFFD9831F3]
                rdx ^= rax;             //xor rdx, rax
                rax = 0;                //and rax, 0xFFFFFFFFC0000000
                rax = _rotl64(rax, 0x10);               //rol rax, 0x10
                rax ^= r9;              //xor rax, r9
        ...
        case 15:
        {
                rbx = read<uintptr_t>(baseModuleAddr + 0x71D924F);              //mov rbx, [0x0000000004B5C324]
                rax = baseModuleAddr;           //lea rax, [0xFFFFFFFFFD982FE4]
                rdx += rax;             //add rdx, rax
                rdx ^= r8;              //xor rdx, r8
                rax = 0;                //and rax, 0xFFFFFFFFC0000000
                rax = _rotl64(rax, 0x10);               //rol rax, 0x10
                ...
                rdx += rax;             //add rdx, rax
                rax = baseModuleAddr;           //lea rax, [0xFFFFFFFFFD982DDC]
                rdx ^= rax;             //xor rdx, rax
...
uintptr_t get_bone_index(uint32_t bone_index)
{
        ...
        rbx = baseModuleAddr;           //lea rbx, [0xFFFFFFFFFDCCACA0]
        ...
        rcx -= rax;             //sub rcx, rax
        rax = read<uint16_t>(rcx + rbx * 1 + 0x71EC670);                //movzx eax, word ptr [rcx+rbx*1+0x71EC670]
        ...
        rcx -= rax;             //sub rcx, rax
        rsi = read<uint16_t>(rcx + rbx * 1 + 0x71F2880);                //movsx esi, word ptr [rcx+rbx*1+0x71F2880]
        return rsi;
}

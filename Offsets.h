    namespace SteamOffset {
        auto ref_def_ptr = 0x11A08178;
        auto name_array = 0x11A29758;
        auto name_array_pos = 0x5E80;
        auto loot_ptr = 0x0B6BDC70;
        auto camera_base = 0x121A1AC0;
        auto camera_pos = 0x01F8;
        auto local_index = 0x5E310;
        auto local_index_pos = 0x02F0;
        auto game_mode = 0x0EC1CE40;
        auto weapon_definitions = 0x11925BA0;
        auto distribute = 0x0A6FD070;
        auto visible_offset = 0x0A90;
        auto visible = 0x024E3C90;
        namespace player {
            auto size = 0x6418;
            auto valid = 0x1826;
            auto pos = 0x61B0;
            auto team = 0x17E8;
            auto weapon_index = 0x163A;
            auto dead_1 = 0x0488;
            auto dead_2 = 0x6110;
        }
        namespace bone {
            auto bone_base = 0x70028;
            auto size = 0x0188;
            auto offset = 0x00D8;
        }
    }
     
    uintptr_t Steamdecrypt_client_info()
    {
        uint64_t mb = baseModuleAddr;
        uint64_t rax = mb, rbx = mb, rcx = mb, rdx = mb, rdi = mb, rsi = mb, r8 = mb, r9 = mb, r10 = mb, r11 = mb, r12 = mb, r13 = mb, r14 = mb, r15 = mb;
     
        rbx = Read<uintptr_t>(baseModuleAddr + 0x11A07A38);
        if (!rbx)
            return rbx;
        ...
        rax ^= Read<uintptr_t>(baseModuleAddr + 0x91090E6);             //xor rax, [0x0000000003735263]
        rbx += rdx;             //add rbx, rdx
    ...
    uintptr_t Steamdecrypt_client_base(uintptr_t client_info)
    {
        const uint64_t mb = baseModuleAddr;
        uint64_t rax = mb, rbx = mb, rcx = mb, rdx = mb, rdi = mb, rsi = mb, r8 = mb, r9 = mb, r10 = mb, r11 = mb, r12 = mb, r13 = mb, r14 = mb, r15 = mb;
        rax = Read<uintptr_t>(client_info + 0x171a10);
        if (!rax)
            return rax;
        ...
        case 0:
        {
            r9 = Read<uintptr_t>(baseModuleAddr + 0x910910E);               //mov r9, [0x000000000639D221]
            rbx = baseModuleAddr;           //lea rbx, [0xFFFFFFFFFD294100]
            ...
            rax = r11;              //mov rax, r11
            uintptr_t RSP_0x50;
            RSP_0x50 = baseModuleAddr + 0x6E33AF72;                 //lea rcx, [0x000000006B5CF07E] : RSP+0x50
            rax ^= RSP_0x50;                //xor rax, [rsp+0x50]
            rcx -= rax;             //sub rcx, rax
            rax = r11 + 0xffffffffd10685d8;                 //lea rax, [r11-0x2EF97A28]
            rcx -= rbx;             //sub rcx, rbx
            rax += rcx;             //add rax, rcx
            rcx = baseModuleAddr + 0x526CB4F4;              //lea rcx, [0x000000004F95F527]
            rcx = ~rcx;             //not rcx
            rcx -= r11;             //sub rcx, r11
            rax += rcx;             //add rax, rcx
            rcx = rax;              //mov rcx, rax
